...
.text
	.p2align 2,0x90
.globl qsort__FiiPPvPFPvPv_i
		.type		 qsort__FiiPPvPFPvPv_i,@function
qsort__FiiPPvPFPvPv_i:
	pushl %ebp
	movl %esp,%ebp
	subl $36,%esp
	pushl %ebx
...
.L76:
	...
	ret
.Lfe10:
		.size		 qsort__FiiPPvPFPvPv_i,.Lfe10-qsort__FiiPPvPFPvPv_i
	.section	.rodata
.LC13:
...
.L93:
	...
	ret
.Lfe11:
		.size		 show__FPi,.Lfe11-show__FPi
	.p2align 2,0x90
.globl main
		.type		 main,@function
main:
...
.L2:
	...
	ret
.Lfe13:
		.size		 __sputc__FiP7__sFILE,.Lfe13-__sputc__FiP7__sFILE
...
.L74:
	...
	ret
.Lfe14:
		.size		 cmpint__FPvT0,.Lfe14-cmpint__FPvT0
	.local	_ran_device
