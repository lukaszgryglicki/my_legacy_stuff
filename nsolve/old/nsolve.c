...
void help()
{
 ...
 printf("pardef1 pardef2 pardef3 t0 t1 y0 yp0 z0 zp0 v0 vp0 h\n");
 ...
 printf("./nsolve 'zp-y-t' 'zp-yp-cos(z)-sin(y)' '-v+t'\n");
 printf("' cos(a)*sin(b)' '-cos(b)' 'sin(a)*sin(b)' 0 5 1 -1 0 2 -3 4 0.01\n");
}
